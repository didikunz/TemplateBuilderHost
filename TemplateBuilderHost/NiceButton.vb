...
Public Class NiceButton
   ...
   Protected Overrides Sub OnMouseUp(mevent As System.Windows.Forms.MouseEventArgs)
      If mevent.Button = Windows.Forms.MouseButtons.Left And Control.ModifierKeys = Keys.None Then
         RaiseEvent Click(Me, New System.EventArgs)
      ElseIf mevent.Button = Windows.Forms.MouseButtons.Left And Control.ModifierKeys = Keys.Control Then
         RaiseEvent ControlClick(Me, New System.EventArgs)
      ElseIf mevent.Button = Windows.Forms.MouseButtons.Left And Control.ModifierKeys = Keys.Shift Then
         RaiseEvent ShiftClick(Me, New System.EventArgs)
      ElseIf mevent.Button = Windows.Forms.MouseButtons.Left And Control.ModifierKeys = Keys.Alt Then
